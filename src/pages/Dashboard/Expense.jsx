...
const Expense = () => {
	...
	const categories = [
		...
		{ name: "groceries", label: "Groceries", color: "#F59E0B" },
		{ name: "transport", label: "Transport", color: "#3B82F6" },
		{ name: "entertainment", label: "Entertainment", color: "#8B5CF6" },
		{ name: "health", label: "Health", color: "#10B981" },
		{ name: "utilities", label: "Utilities", color: "#FBBF24" },
		{ name: "shopping", label: "Shopping", color: "#EC4899" },
		{ name: "other", label: "Other", color: "#64748B" }
	];
