...
import CategoryConfirmationModal from './CategoryConfirmationModal.jsx';
import {
  faMagnifyingGlass,
  faFilter,
  faCalendarAlt,
...
export default function TransactionsPage() {
	...
	const [pendingSMS, setPendingSMS] = useState(null); // For manual categorization modal
	const [confirmedSMS, setConfirmedSMS] = useState(null); // Store confirmed SMS
	...
	// Handler for confirming a category in the modal
	const handleCategoryConfirm = (confirmedData) => {
		console.log('[CategoryConfirm]', confirmedData);
		setConfirmedSMS(confirmedData);
		setPendingSMS(null);
		// You can add transaction to the list here if needed
	};
					...
					<div className="flex items-center justify-between gap-4">
						...
						<div className="flex items-center gap-4">
							<button 
								...
								aria-label="Test SMS Parser"
								title="Test SMS categorization"
								onClick={() => {
									// Example SMS with store that needs manual categorization
									setPendingSMS({
										raw_sms: "FNB:-) M300.00 reserved for purchase @ Footgear (pty)ltd from Smart Account..233594 using card..1601. Avail M1508. 9Jan 13:36",
										store: "Footgear (pty)ltd",
										amount: 300.00,
										balance: 1508,
										bank: "FNB",
